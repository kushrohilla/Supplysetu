 ...
 *
 * Establishes the multi-tenant foundation and audit infrastructure.
 * All subsequent tables are scoped to tenants defined here.
 *
 * Tables:
 * - tenants: Organizational boundaries
...
export async function up(knex: Knex): Promise<void> {
  ...
  // IMMUTABLE: Append-only audit log (foundation for event sourcing)
